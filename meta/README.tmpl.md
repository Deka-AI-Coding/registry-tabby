...
| Model ID | License |
| -------- | ------- |
{% for item in completion_models %}| [Deka-AI-Coding/{{ item.name }}]({{ item.provider_url }}) | [{{ item.license_name }}]({{ item.license_url }}) |
{% endfor %}
...
| Model ID | License |
| -------- | ------- |
{% for item in chat_models %}| [Deka-AI-Coding/{{ item.name }}]({{ item.provider_url }}) | [{{ item.license_name }}]({{ item.license_url }}) |
{% endfor %}
